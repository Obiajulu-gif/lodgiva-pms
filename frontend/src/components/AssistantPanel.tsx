...
/** Lodgiva Agent, docked to the front desk - appears only when the property has enabled
      ...
      {open && (
        <div className="fixed bottom-20 right-5 z-40 flex h-[560px] w-[380px] max-w-[calc(100vw-2.5rem)] flex-col overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-2xl print:hidden">
          <div className="flex items-center gap-2 border-b border-zinc-100 px-4 py-3">
            ...
            <span className="text-sm font-semibold">Lodgiva Agent</span>
            ...
            {msgs.length === 0 && (
              <div className="space-y-2">
                <p className="text-sm text-zinc-600">
                  I can act on the property through Lodgiva's governed tools:
                </p>
